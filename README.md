...
/>
<p align="left"> 
  Me chamo Isabelle Cristine dos Reis Silva,<br>Estou no 3° semestre de Análise e Desenvolvimento de Sistemas na Fatec Zona leste.<br>Além disso, sou formada pela Etec de Itaquera como técnica em informática.<br>Meus projetos focam em:
</p>
...
- **AWS Academy Graduate - Generative AI Foundations - Training Badge**<br>Amazon Web Services (AWS)<br>Emitida em ago de 2026
- **Microsoft Office e Zendesk na Prática**<br>Instituto Percorre<br>Emitida em jan de 2025
...
## `<` FERRAMENTAS `/>`
    ...
    isabelle@cristine: ~$ cat ferramentas.txt
...
## `<` MEIOS_DE_COMUNICAÇÕES `/>`

<div align="center">

### Bora trocar uma ideia? Só chamar por um desses links!
